...
CREATE TABLE IF NOT EXISTS tenant_registry (
  ...
  logo_firm_nr    INTEGER,
  logo_period_nr  INTEGER,
  logo_db         TEXT,
...
ON CONFLICT (code) DO UPDATE SET
  ...
  logo_firm_nr = COALESCE(EXCLUDED.logo_firm_nr, tenant_registry.logo_firm_nr),
  logo_period_nr = COALESCE(EXCLUDED.logo_period_nr, tenant_registry.logo_period_nr),
  logo_db = COALESCE(NULLIF(EXCLUDED.logo_db, ''), tenant_registry.logo_db),
