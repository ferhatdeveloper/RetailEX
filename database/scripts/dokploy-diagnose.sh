...
echo "2) Tam stack → POSTGRES_PASSWORD='...' docker compose -f docker-compose.dokploy.yml up -d postgres retailex_bridge retailex_whatsapp_bridge retailex_frontend api_gateway"
