-- Migration: 011_wms_cleanup.sql
-- Description: WMS Cleanup and Stock Movement Tables

-- 1. Add manager_name to stores if not exists
...
CREATE TABLE IF NOT EXISTS wms.transfer_items (
    ...
    product_id UUID, -- Soft link to rex_{firm}_products
...
-- 3. Redefine CREATE_PERIOD_TABLES to support Stock Movement Header/Items
