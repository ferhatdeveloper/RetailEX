-- Ödeme Planları + Masraf Merkezleri: tüm firmalarda varsayılan gizli.
-- Menü Yönetimi’nden istenirse açılır. Tüm preset’lerin hidden_modules listesine eklenir.
              ...
              (
                ...
                FROM (
                  ...
                  FROM (
                    ...
                    UNION
                    SELECT 'payment-plans'::text
                    UNION
                    SELECT 'cost-centers'::text
                  ) u
                ) d
              )
            ) AS updated_elem
