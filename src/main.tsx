...
/**
 * PWA (standalone) modunda yukarıdan aşağı sürükleme ile sayfayı yeniler.
 * - Yalnızca PWA/standalone çalışır.
 * - Sadece en üstteki scroll konumunda aktif olur.
 */
  ...
  useEffect(() => {
    ...
    const updateTracking = (clientY: number, preventDefault?: () => void) => {
      ...
      if (deltaY > 0) {
        ...
        if (maxDeltaY > 12) {
          // Native pull-to-refresh yerine uygulama kontrollü yenileme.
          preventDefault?.();
        }
      }
    };
