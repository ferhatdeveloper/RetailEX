  ...
  return [
    ...
    },
    {
      ...
      modules: [
        ...
        m('pos.discount', ['EXECUTE']),
        m('pos.refund', ['EXECUTE']),
        m('pos.cancel_sale', ['EXECUTE']),
        m('pos.change_price', ['EXECUTE']),
        m('pos.open_drawer', ['EXECUTE']),
    ...
    },
    {
      ...
      modules: [
        ...
        m('stockmovements', ['READ', 'CREATE', 'UPDATE', 'EXECUTE']),
        m('store-transfer', ['READ', 'CREATE', 'UPDATE', 'EXECUTE']),
        m('warehousetransfer', ['READ', 'CREATE', 'UPDATE', 'EXECUTE']),
        m('warehouse-definitions', ['READ', 'CREATE', 'UPDATE', 'DELETE']),
        m('purchase', ['READ', 'CREATE', 'UPDATE', 'DELETE']),
        m('inventory-check', ['READ', 'CREATE', 'UPDATE', 'EXECUTE']),
        m('stockcount', ['READ', 'CREATE', 'UPDATE', 'EXECUTE']),
      ],
    },
    {
      id: 'finance',
      ...
      modules: [
        ...
        m('kasalar', ['READ', 'CREATE', 'UPDATE', 'DELETE', 'EXECUTE']),
        m('finance.bank', ['READ', 'CREATE', 'UPDATE', 'DELETE', 'EXECUTE']),
        m('banks', ['READ', 'CREATE', 'UPDATE', 'DELETE', 'EXECUTE']),
        ...
        m('salesinvoice', ['READ', 'CREATE', 'UPDATE', 'DELETE', 'EXECUTE']),
        m('purchaseinvoice', ['READ', 'CREATE', 'UPDATE', 'DELETE', 'EXECUTE']),
        m('salesreturn', ['READ', 'CREATE', 'UPDATE', 'EXECUTE']),
        m('purchasereturn', ['READ', 'CREATE', 'UPDATE', 'EXECUTE']),
