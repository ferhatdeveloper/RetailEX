...
export const translations: any = {
  tr: {
    ...
    customizeQuickAccess: 'Favorileri Düzenle',
    customizeFavorites: 'Favorileri Düzenle',
    favorites: 'Favoriler',
    editFavorites: 'Düzenle',
    addToFavorites: 'Favorilere ekle',
    removeFromFavorites: 'Favorilerden çıkar',
    noFavoritesYet: 'Henüz favori eklenmedi',
    noFavoritesHint: 'Menüdeki yıldız ile ekran ekleyin veya Düzenle’den seçin',
    noMenuItemsForFavorites: 'Favoriye eklenebilecek menü öğesi yok',
    maxFavoritesHint: 'En fazla 12 favori seçebilirsiniz',
    favoritesSelected: 'favori seçildi',
    ...
    max8Shortcuts: 'En fazla 12 favori seçebilirsiniz',
    ...
    shortcutsSelected: 'favori seçildi',
    sidebar: {
      ...
      customizeQuickAccess: 'تعديل المفضلة',
      customizeFavorites: 'تعديل المفضلة',
      favorites: 'المفضلة',
      editFavorites: 'تعديل',
      addToFavorites: 'إضافة إلى المفضلة',
      removeFromFavorites: 'إزالة من المفضلة',
      noFavoritesYet: 'لا توجد مفضلات بعد',
      noFavoritesHint: 'أضف من القائمة بالنجمة أو من تعديل',
      noMenuItemsForFavorites: 'لا توجد عناصر قائمة للمفضلة',
      maxFavoritesHint: 'يمكنك اختيار ما يصل إلى 12 مفضلة',
      favoritesSelected: 'تم اختيار المفضلات',
      dailySalesPerformance: 'Günlük Satış Performansı',
      dailySummary: 'Günlük Özet',
      darkMode: 'Koyu Tema',
      dashboard: 'Dashboard',
      ...
      max8Shortcuts: 'يمكنك اختيار ما يصل إلى 12 مفضلة',
      ...
      searchPlaceholderFull: 'Menüde hızlı ara...',
      ...
      shortcutsSelected: 'تم اختيار المفضلات',
    ...
    party: {
      ...
      cardType: {
        ...
        supplier: 'Tedarikçi',
        employee: 'Personel',
        partner: 'Şirket Ortağı',
      },
      searchPlaceholder: 'Cari ara...',
      newButton: 'Yeni Cari',
      empty: 'Kayıt bulunamadı.',
      deleteSuccess: 'Cari silindi',
      saveSuccess: 'Cari kaydedildi',
      confirmDeleteTitle: 'Cari silinsin mi?',
      editModal: {
        title: 'Cari Düzenle',
        titleNew: 'Yeni Cari',
        titleEdit: 'Cari Düzenle',
        subtitle: 'Müşteri, tedarikçi, personel veya şirket ortağı kartı',
      },
      fields: {
        cardType: 'Cari Tipi',
        code: 'Kod',
    custColUniqueId: 'Benzersiz ID',
        codePlaceholder: 'MÜS-001',
        name: 'Ad / Ünvan',
      ...
      employeeSection: 'Personel Bilgileri',
      employee: {
        ...
        balanceLabelAdvance: 'Avans Bakiyesi',
        balanceLabelZero: 'Bakiye Yok',
        balanceHintAvans: 'Ödenmemiş maaş alacağı',
        balanceHintAdvance: 'Hakkedişi aşan avans / ödeme',
        balanceHintZero: 'Bakiye yok',
      },
      partnerSection: 'Şirket Ortağı Bilgileri',
      partner: {
        sharePct: 'Hisse Payı (%)',
        capitalContribution: 'Sermaye Katkısı',
        role: 'Ortak Rolü',
        roleMajor: 'Ana Ortak',
        roleMinor: 'Diğer Ortak',
        partnerSince: 'Ortaklık Başlangıcı',
        iban: 'IBAN',
        balanceLabel: 'Dağıtılmamış Kâr Payı',
        balanceLabelNegative: 'Sermaye Borcu',
      ...
      partnerCash: {
        ...
        cashIn: 'Para girişi',
        cashOut: 'Para çıkışı',
        cashInHint: 'Ortak kasaya para koyar: kasa artar, ortak hesabındaki alacak artar.',
        cashOutHint: 'Ortak kasadan para çeker: kasa azalır, ortak hesabındaki alacak azalır.',
        amount: 'Tutar',
        register: 'Kasa / Banka',
        chooseRegister: 'Kasa/banka seçin',
        note: 'Açıklama',
        notePlaceholder: 'Açıklama yazın',
        amountPositive: 'Tutar pozitif olmalı',
        registerRequired: 'Kasa/banka seçilmedi',
        saveSuccess: 'Ortak kasa işlemi kaydedildi',
        movements: 'Hareketler',
        tabForm: 'İşlem',
      ...
      payroll: {
        title: 'Maaş / Avans',
        openPayroll: 'Maaş / Avans',
        paySalary: 'Maaş Öde',
        payAdvance: 'Avans Ver',
        reconcile: 'Avans Mahsup',
        amount: 'Tutar',
        register: 'Kasa / Banka',
        chooseRegister: 'Kasa/banka seçin',
        note: 'Açıklama',
        ...
        amountPositive: 'Tutar pozitif olmalı',
        registerRequired: 'Kasa/banka seçilmedi',
        saveSuccess: 'Personel işlemi kaydedildi',
        recent: 'Hareketler',
        movements: 'Hareketler',
        tabForm: 'İşlem',
        openStatement: 'Hesap ekstresi',
        accrueMonth: 'Bu ay hakkediş',
        accrueSuccess: 'Aylık maaş hakkedişi oluşturuldu',
        accrueNone: 'Hakkediş için aylık brüt maaşı olan personel yok. Personel kartına maaş yazın.',
        accrueExists: 'Bu ayın hakkedişi zaten kayıtlı',
        accrueCleanedBeforeHire: 'İşe giriş öncesi {n} otomatik hakkediş temizlendi',
        accrueCleanedPastMonths: 'Geçmiş aylara ait {n} otomatik hakkediş temizlendi',
        accrueCleanedDuplicates: 'Aynı aya ait {n} çift hakkediş temizlendi',
        movementsThisMonth: 'Bu ay hareketleri',
        movementsAll: 'Tüm hareketler',
        movementsShowMonth: 'Yalnızca bu ay',
        movementsShowAll: 'Tüm geçmiş',
        movementsPriorBalance: 'Önceki aylardan bakiye',
        voucherTitleSalary: 'Maaş Ödeme Makbuzu',
        voucherTitleAdvance: 'Avans Ödeme Makbuzu',
        voucherTitleReconcile: 'Avans Mahsup Belgesi',
        voucherTitleAccrual: 'Maaş Hakkediş Fişi',
      },
      statement: {
        title: 'Personel Hesap Ekstresi',
        empty: 'Bu tarih aralığında hakkediş / maaş / avans hareketi yok.',
        opening: 'Açılış',
        closing: 'Dönem bakiyesi',
        printVoucher: 'Makbuz yazdır',
        printError: 'Yazdırılamadı',
        loadError: 'Hesap ekstresi yüklenemedi',
        printRowHint: 'Bu satır için makbuz yok',
        showCancelled: 'İptal edilenleri göster',
        hideCancelled: 'İptal edilenleri gizle',
        showCancelledHint: 'İptal edilen (CANCELLED_*) satırları da ekstreye dahil et',
        cancelledBadge: 'İptal',
        excludeCompanyDebts: 'Şirket borçları hariç',
        excludeCompanyDebtsHint: 'İşletmenin ortağa/personele borçlandığı (kâr dağıtımı, sermaye tahsilatı) hareketleri gizle',
        excludeCompanyDebtsNoEffect: 'Bu filtre müşteri/tedarikçi ekstresinde geçerli değildir',
        excludedBadge: 'Hariç tutulan',
        deleteRowTitle: 'Hareketi sil',
        deleteRowHint: 'Bu satır silinince kasa ve ortak bakiyesi geri alınır. Emin misiniz?',
        deleteRowClickHint: 'Silmek için satıra tıklayın veya çöp ikonunu kullanın',
        deleteRowOnlyUserAdded: 'Yalnızca sonradan eklenen para giriş/çıkış silinebilir; otomatik kâr payı silinemez',
        deleteRowSuccess: 'Hareket silindi',
        deleteRowError: 'Hareket silinemedi',
      },
      distribution: {
        title: 'Ortak Kâr / Zarar Dağıtımı',
        subtitle: 'Cari ortak kartlarındaki pay % ile kârı hesaba yaz; nakit ayrı para girişi/çıkışı ile alınır',
        openDistribution: 'Kâr Dağıt',
        baseType: 'Dağıtım Tabanı',
        triggerType: 'Tetik Modu',
        manualAmount: 'Manuel Tutar',
        computedAmount: 'Hesaplanan Tutar',
        register: 'Kasa / Banka',
        chooseRegister: 'Kasa/banka seçin',
        notes: 'Not',
        registerRequired: 'Kasa/banka seçilmedi',
        accountOnlyHint: 'Dağıtım nakit yazmaz: tutar ortak cari hesabına pay % oranında işlenir. Para çekmek veya koymak için ortak satırındaki para girişi / çıkışı kullanın.',
        execute: 'Dağıtımı Uygula',
        executeSuccess: 'Dağıtım uygulandı',
        ...
        amount: 'Tutar',
        total: 'Toplam',
        history: 'Geçmiş Dağıtımlar',
        base: {
          netProfit: 'Net Kâr',
          netProfitDesc: 'Brüt satış − alış iade − onaylı giderler',
          cashNet: 'Kasa Net',
          cashNetDesc: 'Kasa + banka net pozisyonu (kümülatif)',
          manual: 'Manuel Tutar',
          manualDesc: 'Yönetici kendi tutarını girer',
        },
        trigger: {
          manual: 'Manuel',
          daily: 'Günlük (Kasa Kapanışı)',
          period: 'Dönem Sonu',
        },
      },
      table: {
        code: 'Kod',
        id: 'ID',
        idCopyHint: 'ID kopyala',
        archived: 'ARŞİV',
        archivedHint: 'Arşivlenmiş (birleştirildi)',
        name: 'Ad',
        type: 'Tip',
        phone: 'Telefon',
        salary: 'Maaş',
      ...
      merge: {
        title: 'Cari Birleştirme (Merge)',
        subtitle: 'İki cari kartı tek hedef altında topla. Audit trail korunur.',
        openButton: 'Birleştir',
        source: 'Kaynak (Arşivlenecek)',
        target: 'Hedef (Kalacak)',
        summary: 'Etkilenen satır sayıları (tüm dönemler dahil)',
        balanceAfter: 'Birleştirme sonrası hedef bakiye',
        balanceHint: 'Farklı kart tipleri birleştirildi — bakiye yine de toplanır. İşaret yönü kart tipine göre ayrı ele alınır.',
        warnings: 'Uyarılar',
        notesLabel: 'Not (opsiyonel, audit için)',
        notesPlaceholder: 'Örn: Mükerrer kayıt, telefon numarası farklı',
        confirmText: 'Kaynak kartın arşivleneceğini, tüm satırların hedef karta yönlendirileceğini ve bakiyelerin toplanacağını anlıyorum. Bu işlem geri alınabilir (unmerge) — eski kart pasif ama verileri korunur.',
        preview: 'Önizleme',
        execute: 'Birleştirmeyi Onayla',
        success: 'Birleştirme tamamlandı. {{code}} arşivlendi.',
        doneTitle: 'Birleştirme tamamlandı',
        doneText: '{{source}} → {{target}} altında birleştirildi.',
      },
      error: {
  ...
  en: {
    ...
    customizeQuickAccess: 'Edit Favorites',
    customizeFavorites: 'Edit Favorites',
    favorites: 'Favorites',
    editFavorites: 'Edit',
    addToFavorites: 'Add to favorites',
    removeFromFavorites: 'Remove from favorites',
    noFavoritesYet: 'No favorites yet',
    noFavoritesHint: 'Star a menu item or use Edit to pick screens',
    noMenuItemsForFavorites: 'No menu items available for favorites',
    maxFavoritesHint: 'You can select up to 12 favorites',
    ...
    materials: 'Materials',
    max8Shortcuts: 'You can select up to 12 favorites',
    ...
    menu: {
      ...
      definitions: 'Definitions',
      definitionsParameters: 'Parameters',
    ...
    searchPlaceholderFull: 'Quick search in menu...',
    ...
    shortcutsSelected: 'favorites selected',
    sidebar: {
    ...
    party: {
      ...
      saveSuccess: 'Party saved',
      confirmDeleteTitle: 'Delete party?',
      editModal: {
        title: 'Edit Party',
        titleNew: 'New Party',
        titleEdit: 'Edit Party',
        subtitle: 'Customer, supplier, employee or business partner card',
      },
      fields: {
        cardType: 'Party Type',
        code: 'Code',
    custColUniqueId: 'Unique ID',
        codePlaceholder: 'CUS-001',
        name: 'Name / Title',
      ...
      employee: {
        ...
        balanceLabelAdvance: 'Advance Balance',
        balanceLabelZero: 'No Balance',
        balanceHintAvans: 'Unpaid salary entitlement',
        balanceHintAdvance: 'Advance / payment exceeds entitlement',
        balanceHintZero: 'No balance',
      },
      partnerSection: 'Partner Details',
      partner: {
        sharePct: 'Share Percentage (%)',
        capitalContribution: 'Capital Contribution',
        role: 'Partner Role',
        roleMajor: 'Major Partner',
        roleMinor: 'Minor Partner',
        partnerSince: 'Partnership Start',
        iban: 'IBAN',
        balanceLabel: 'Undistributed Profit Share',
        balanceLabelNegative: 'Capital Debt',
      ...
      partnerCash: {
        ...
        cashIn: 'Cash in',
        cashOut: 'Cash out',
        cashInHint: 'Partner puts money into the till: cash increases, partner receivable increases.',
        cashOutHint: 'Partner withdraws cash: till decreases, partner receivable decreases.',
        amount: 'Amount',
        register: 'Cash / Bank',
        chooseRegister: 'Choose cash/bank',
        note: 'Note',
        notePlaceholder: 'Enter note',
        amountPositive: 'Amount must be positive',
        registerRequired: 'Cash/bank required',
        saveSuccess: 'Partner cash transaction saved',
      ...
      payroll: {
        ...
        openPayroll: 'Salary / Advance',
        paySalary: 'Pay Salary',
        payAdvance: 'Pay Advance',
        reconcile: 'Reconcile Advance',
        amount: 'Amount',
        register: 'Cash / Bank',
        chooseRegister: 'Choose cash/bank',
        note: 'Note',
        ...
        amountPositive: 'Amount must be positive',
        registerRequired: 'Cash/bank required',
        saveSuccess: 'Employee transaction saved',
        recent: 'Transactions',
        movements: 'Transactions',
        tabForm: 'Operation',
        openStatement: 'Account statement',
        accrueMonth: 'Accrue this month',
        accrueSuccess: 'Monthly salary entitlement created',
        accrueNone: 'No employees with a monthly gross salary. Set salary on the employee card.',
        accrueExists: 'This month is already accrued',
        accrueCleanedBeforeHire: 'Removed {n} auto-accrual(s) before hire date',
        accrueCleanedPastMonths: 'Removed {n} auto-accrual(s) from previous months',
        accrueCleanedDuplicates: 'Removed {n} duplicate accrual(s) in the same month',
        movementsThisMonth: 'This month',
        movementsAll: 'All movements',
        movementsShowMonth: 'This month only',
        movementsShowAll: 'Full history',
        movementsPriorBalance: 'Balance from prior months',
        voucherTitleSalary: 'Salary Payment Voucher',
        voucherTitleAdvance: 'Advance Payment Voucher',
        voucherTitleReconcile: 'Advance Settlement Voucher',
        voucherTitleAccrual: 'Salary Accrual Voucher',
      },
      statement: {
        title: 'Employee Account Statement',
        empty: 'No salary / advance movements in this date range.',
        opening: 'Opening',
        closing: 'Period balance',
        printVoucher: 'Print voucher',
        printError: 'Print failed',
        loadError: 'Could not load account statement',
        printRowHint: 'No voucher for this row',
        showCancelled: 'Show cancelled',
        hideCancelled: 'Hide cancelled',
        showCancelledHint: 'Include cancelled (CANCELLED_*) rows in the statement',
        cancelledBadge: 'Cancelled',
        excludeCompanyDebts: 'Exclude company debts',
        excludeCompanyDebtsHint: 'Hide distributions and capital collections payable by the company',
        excludeCompanyDebtsNoEffect: 'This filter has no effect on customer/supplier statements',
        excludedBadge: 'Excluded',
        deleteRowTitle: 'Delete movement',
        deleteRowHint: 'Deleting this row reverses cash and partner balances. Continue?',
        deleteRowClickHint: 'Click the row or trash icon to delete',
        deleteRowOnlyUserAdded: 'Only later cash in/out entries can be deleted; automatic profit shares cannot',
        deleteRowSuccess: 'Movement deleted',
        deleteRowError: 'Could not delete movement',
      },
      distribution: {
        title: 'Partner Profit / Loss Distribution',
        subtitle: 'Post profit to partner accounts by share % on the cards; cash is a separate in/out',
        openDistribution: 'Distribute',
        baseType: 'Distribution Base',
        ...
        notes: 'Note',
        registerRequired: 'Cash/bank required',
        accountOnlyHint: 'Distribution does not move cash: the amount is posted to each partner account by share %. Use cash in / cash out on the partner row to take or put money.',
        execute: 'Execute Distribution',
        executeSuccess: 'Distribution applied',
        previewTitle: 'Preview',
        totalPct: 'Total Share',
        partner: 'Partner',
        sharePct: 'Share %',
        amount: 'Amount',
        total: 'Total',
        history: 'Recent Distributions',
        base: {
          netProfit: 'Net Profit',
          netProfitDesc: 'Gross sales − purchase returns − approved expenses',
          cashNet: 'Cash Net',
          cashNetDesc: 'Cumulative cash + bank position',
          manual: 'Manual Amount',
          manualDesc: 'Manager enters the amount',
        },
        trigger: {
          manual: 'Manual',
          daily: 'Daily (Cash Close)',
          period: 'Period End',
        },
      },
      table: {
        ...
        idCopyHint: 'Copy ID',
        archived: 'ARCHIVED',
        archivedHint: 'Archived (merged into another account)',
        name: 'Name',
        type: 'Type',
        phone: 'Phone',
        salary: 'Salary',
      ...
      merge: {
        title: 'Account Merge',
        subtitle: 'Merge two account cards into a single target. Audit trail is preserved.',
        openButton: 'Merge',
        source: 'Source (will be archived)',
        target: 'Target (will remain)',
        summary: 'Affected row counts (all periods)',
        balanceAfter: 'Target balance after merge',
        balanceHint: 'Different card types merged — balances are still summed. Sign direction is handled per card type.',
        warnings: 'Warnings',
        notesLabel: 'Notes (optional, audit)',
        notesPlaceholder: 'E.g. duplicate record, different phone number',
        confirmText: 'I understand that the source card will be archived, all transactions will be redirected to the target card, and balances will be summed. This is reversible (unmerge) — the old card stays inactive but its data is preserved.',
        preview: 'Preview',
        execute: 'Confirm Merge',
        success: 'Merge complete. {{code}} archived.',
        doneTitle: 'Merge completed',
        doneText: '{{source}} → {{target}} merged.',
      },
      error: {
  ...
  ar: {
    ...
    menu: {
      ...
      definitions: 'التعريفات',
      definitionsParameters: 'المعلمات',
    ...
    sidebar: {
      ...
      searchPlaceholderFull: 'بحث سريع في القائمة...',
    ...
    party: {
      ...
      editModal: {
        ...
        subtitle: 'بطاقة عميل أو مورد أو موظف أو شريك',
      },
      fields: {
        cardType: 'نوع الحساب',
        code: 'الرمز',
    custColUniqueId: 'المعرف الفريد',
        codePlaceholder: 'CUS-001',
        name: 'الاسم',
      ...
      employee: {
        ...
        balanceLabelAdvance: 'رصيد السلفة',
        balanceLabelZero: 'لا رصيد',
        balanceHintAvans: 'راتب غير مدفوع',
        balanceHintAdvance: 'سلفة / دفعة تتجاوز الاستحقاق',
        balanceHintZero: 'لا رصيد',
      },
      partnerSection: 'بيانات الشريك',
      partner: {
        sharePct: 'نسبة الحصة (%)',
        capitalContribution: 'المساهمة الرأسمالية',
        role: 'دور الشريك',
        roleMajor: 'الشريك الرئيسي',
        roleMinor: 'الشريك الثانوي',
        partnerSince: 'بداية الشراكة',
        iban: 'IBAN',
        balanceLabel: 'حصة الأرباح غير الموزعة',
      ...
      partnerCash: {
        ...
        openCash: 'إيداع / سحب نقد',
        cashIn: 'إيداع نقد',
        cashOut: 'سحب نقد',
        cashInHint: 'يضع الشريك مالاً في الصندوق: يزيد الصندوق ويزيد مستحق الشريك.',
        cashOutHint: 'يسحب الشريك من الصندوق: ينقص الصندوق وينقص مستحق الشريك.',
        amount: 'المبلغ',
        register: 'الخزينة / البنك',
        chooseRegister: 'اختر',
        note: 'ملاحظة',
        notePlaceholder: 'ملاحظة',
        amountPositive: 'المبلغ يجب أن يكون موجباً',
        registerRequired: 'الخزينة/البنك مطلوب',
        saveSuccess: 'تم حفظ حركة نقد الشريك',
        movements: 'الحركات',
        tabForm: 'عملية',
      ...
      payroll: {
        title: 'الراتب / السلفة',
        openPayroll: 'الراتب / السلفة',
        paySalary: 'دفع الراتب',
        payAdvance: 'صرف سلفة',
        reconcile: 'مقاصة السلفة',
        amount: 'المبلغ',
        register: 'الخزينة / البنك',
        chooseRegister: 'اختر',
        note: 'ملاحظة',
        ...
        accrueMonth: 'استحقاق هذا الشهر',
        accrueSuccess: 'تم إنشاء استحقاق الراتب الشهري',
        accrueNone: 'لا يوجد موظف براتب شهري. أدخل الراتب في بطاقة الموظف.',
        accrueExists: 'استحقاق هذا الشهر مسجل مسبقاً',
        accrueCleanedBeforeHire: 'تمت إزالة {n} استحقاق تلقائي قبل تاريخ التعيين',
        accrueCleanedPastMonths: 'تمت إزالة {n} استحقاق تلقائي من الأشهر السابقة',
        accrueCleanedDuplicates: 'تمت إزالة {n} استحقاق مكرر في نفس الشهر',
        movementsThisMonth: 'حركات هذا الشهر',
        movementsAll: 'كل الحركات',
        movementsShowMonth: 'هذا الشهر فقط',
        movementsShowAll: 'كل السجل',
        movementsPriorBalance: 'رصيد من الأشهر السابقة',
        voucherTitleSalary: 'إيصال دفع الراتب',
        voucherTitleAdvance: 'إيصال السلفة',
        voucherTitleReconcile: 'مستند مقاصة السلفة',
        voucherTitleAccrual: 'فيش استحقاق الراتب',
      },
      statement: {
        title: 'كشف حساب الموظف',
        empty: 'لا توجد حركات راتب / سلفة في هذا النطاق.',
        opening: 'افتتاح',
        closing: 'رصيد الفترة',
        printVoucher: 'طباعة الإيصال',
        printError: 'تعذر الطباعة',
        loadError: 'تعذر تحميل كشف الحساب',
        printRowHint: 'لا إيصال لهذا السطر',
        showCancelled: 'إظهار الملغاة',
        hideCancelled: 'إخفاء الملغاة',
        showCancelledHint: 'تضمين الصفوف الملغاة (CANCELLED_*) في الكشف',
        cancelledBadge: 'ملغى',
        excludeCompanyDebts: 'استثناء ديون الشركة',
        excludeCompanyDebtsHint: 'إخفاء توزيعات الأرباح وتحصيلات رأس المال المستحقة على الشركة',
        excludeCompanyDebtsNoEffect: 'هذا المرشح غير فعال في كشوفات العملاء/الموردين',
        excludedBadge: 'مستثنى',
        deleteRowTitle: 'حذف الحركة',
        deleteRowHint: 'حذف هذا السطر يعكس رصيد الصندوق والشريك. هل أنت متأكد؟',
        deleteRowClickHint: 'انقر على الصف أو أيقونة الحذف للحذف',
        deleteRowOnlyUserAdded: 'يمكن حذف إدخالات النقد المضافة لاحقاً فقط؛ حصص الربح التلقائية لا تُحذف',
        deleteRowSuccess: 'تم حذف الحركة',
        deleteRowError: 'تعذر حذف الحركة',
      },
      distribution: {
        title: 'توزيع الأرباح / الخسائر',
        subtitle: 'ترحيل الربح إلى حسابات الشركاء حسب النسبة في البطاقات؛ النقد حركة منفصلة',
        openDistribution: 'توزيع',
        baseType: 'أساس التوزيع',
        triggerType: 'طريقة التفعيل',
        manualAmount: 'مبلغ يدوي',
        computedAmount: 'المبلغ المحسوب',
        register: 'الخزينة / البنك',
        chooseRegister: 'اختر',
        notes: 'ملاحظة',
        registerRequired: 'الخزينة/البنك مطلوب',
        accountOnlyHint: 'التوزيع لا يحرك الصندوق: يُرحَّل المبلغ إلى حساب كل شريك حسب النسبة. للإيداع أو السحب استخدم حركة نقد الشريك.',
        execute: 'تطبيق التوزيع',
        executeSuccess: 'تم التوزيع',
        previewTitle: 'معاينة',
        totalPct: 'إجمالي النسبة',
        partner: 'الشريك',
        sharePct: 'النسبة %',
        amount: 'المبلغ',
        total: 'الإجمالي',
        history: 'التوزيعات السابقة',
        base: {
          netProfit: 'صافي الربح',
          netProfitDesc: 'إجمالي المبيعات − مردودات − مصروفات معتمدة',
          cashNet: 'صافي النقد',
          cashNetDesc: 'مركز النقد التراكمي',
          manual: 'مبلغ يدوي',
          manualDesc: 'المدير يدخل المبلغ',
        },
        trigger: {
          manual: 'يدوي',
          daily: 'يومي (إغلاق الصندوق)',
          period: 'نهاية الفترة',
        },
      },
      table: {
        code: 'الرمز',
        id: 'المعرف',
        idCopyHint: 'نسخ المعرف',
        archived: 'مؤرشف',
        archivedHint: 'مؤرشف (تم دمجه مع حساب آخر)',
        name: 'الاسم',
        type: 'النوع',
        phone: 'الهاتف',
        salary: 'الراتب',
      ...
      merge: {
        title: 'دمج الحسابات',
        subtitle: 'ادمج بطاقتي حساب في بطاقة هدف واحدة. سجل التدقيق محفوظ.',
        openButton: 'دمج',
        source: 'المصدر (سيتم أرشفته)',
        target: 'الهدف (سيبقى)',
        summary: 'عدد الصفوف المتأثرة (جميع الفترات)',
        balanceAfter: 'رصيد الهدف بعد الدمج',
        balanceHint: 'تم دمج أنواع بطاقات مختلفة — لا تزال الأرصدة تُجمع. تتم معالجة اتجاه الإشارة حسب نوع البطاقة.',
        warnings: 'تحذيرات',
        notesLabel: 'ملاحظات (اختياري، للمراجعة)',
        notesPlaceholder: 'مثال: سجل مكرر، رقم هاتف مختلف',
        confirmText: 'أفهم أنه سيتم أرشفة بطاقة المصدر، وإعادة توجيه جميع المعاملات إلى بطاقة الهدف، وجمع الأرصدة. هذا قابل للعكس (إلغاء الدمج) — تبقى البطاقة القديمة غير نشطة لكن بياناتها محفوظة.',
        preview: 'معاينة',
        execute: 'تأكيد الدمج',
        success: 'اكتمل الدمج. {{code}} مؤرشف.',
        doneTitle: 'اكتمل الدمج',
        doneText: '{{source}} → {{target}} تم دمجهما.',
      },
      error: {
  ...
  ku: {
    ...
    customizeQuickAccess: 'دەستکاریی دڵخوازەکان',
    customizeFavorites: 'دەستکاریی دڵخوازەکان',
    favorites: 'دڵخوازەکان',
    editFavorites: 'دەستکاری',
    addToFavorites: 'زیادکردن بۆ دڵخوازەکان',
    removeFromFavorites: 'لابردن لە دڵخوازەکان',
    noFavoritesYet: 'هێشتا دڵخواز زیاد نەکراوە',
    noFavoritesHint: 'لە مینیو ئەستێرە بکە یان لە دەستکاری هەڵبژێرە',
    noMenuItemsForFavorites: 'هیچ بڕگەی مینیو بۆ دڵخوازەکان نییە',
    maxFavoritesHint: 'دەتوانیت تا 12 دڵخواز هەڵبژێریت',
    favoritesSelected: 'دڵخوازەکان هەڵبژێردران',
    ...
    materials: 'ماددەکان',
    max8Shortcuts: 'دەتوانیت تا 12 دڵخواز هەڵبژێریت',
    maxShortcutsTitle: 'En fazla 8 kısayol seçebilirsiniz',
    menu: {
      ...
      definitions: 'پێناسەکان',
      definitionsParameters: 'پارامێتەر',
    ...
    searchPlaceholderFull: 'گەڕانی خێرا لە لیستەکە...',
    ...
    party: {
      ...
      cardType: {
        ...
        supplier: 'دابینکەر',
        employee: 'کارمەند',
        partner: 'هاوبەشی کۆمپانیا',
      },
      searchPlaceholder: 'گەڕان...',
      newButton: 'هەژماری نوێ',
      empty: 'هیچ تۆمارێک نەدۆزرایەوە.',
      deleteSuccess: 'هەژمارەکە سڕایەوە',
      saveSuccess: 'هەژمارەکە پاشەکەوت کرا',
      confirmDeleteTitle: 'دڵنیایت لە سڕینەوەی؟',
      editModal: {
        title: 'دەستکاری هەژمار',
        titleNew: 'هەژماری نوێ',
        titleEdit: 'دەستکاری هەژمار',
        subtitle: 'کڕیار، دابینکەر، کارمەند یان هاوبەشی کۆمپانیا',
      },
      fields: {
        cardType: 'جۆری هەژمار',
        code: 'کۆد',
    custColUniqueId: 'ناسنامەی بێهاوتا',
        codePlaceholder: 'CUS-001',
        name: 'ناو / ناونیشان',
        ...
        email: 'ئیمەیڵ',
        taxNr: 'ژمارەی باج',
        taxOffice: 'فەرمانگەی باج',
        address: 'ناونیشان',
        notes: 'تێبینی',
        active: 'چالاک',
        balance: 'باڵانس',
      },
      employeeSection: 'زانیاری کارمەند',
      employee: {
        ...
        balanceLabelAdvance: 'باڵانسی پێشەکی',
        balanceLabelZero: 'باڵانس نییە',
        balanceHintAvans: 'مووچەی نەدراو',
        balanceHintAdvance: 'پێشەکی / پارەدان لە ماف زیاترە',
        balanceHintZero: 'باڵانس نییە',
      },
      partnerSection: 'زانیاری هاوبەش',
      partner: {
        sharePct: 'ڕێژەی هاوبەشی (%)',
        capitalContribution: 'بەشداری سەرمایە',
        role: 'ڕۆڵی هاوبەش',
        roleMajor: 'هاوبەشی سەرەکی',
        roleMinor: 'هاوبەشی لاوەکی',
        partnerSince: 'سەرەتای هاوبەشی',
        iban: 'IBAN',
        balanceLabel: 'پشکی قازانجی دابەش نەکراو',
      ...
      partnerCash: {
        ...
        openCash: 'هاتنی پارە / چوونەدەرەوە',
        cashIn: 'هاتنی پارە',
        cashOut: 'چوونەدەرەوەی پارە',
        cashInHint: 'هاوبەش پارە دەخاتە سندوق: سندوق زیاد دەبێت و داواکاری هاوبەش زیاد دەبێت.',
        cashOutHint: 'هاوبەش پارە لە سندوق دەکێشێت: سندوق کەم دەبێت و داواکاری هاوبەش کەم دەبێت.',
        amount: 'بڕ',
        register: 'سندوق / بانک',
        chooseRegister: 'سندوق/بانک هەڵبژێرە',
        note: 'تێبینی',
        notePlaceholder: 'تێبینی بنووسە',
        amountPositive: 'بڕ دەبێت ئەرێنی بێت',
        registerRequired: 'سندوق/بانک پێویستە',
        saveSuccess: 'مەعاملەی پارەی هاوبەش پاشەکەوت کرا',
        movements: 'مەعاملەکان',
        tabForm: 'کردار',
      ...
      payroll: {
        title: 'مووچە / پێشەکی',
        openPayroll: 'مووچە / پێشەکی',
        paySalary: 'دانی مووچە',
        payAdvance: 'دانی پێشەکی',
        reconcile: 'پاکتاوکردنی پێشەکی',
        amount: 'بڕ',
        register: 'سندوق / بانک',
        chooseRegister: 'سندوق/بانک هەڵبژێرە',
        note: 'تێبینی',
        ...
        amountPositive: 'بڕ دەبێت ئەرێنی بێت',
        registerRequired: 'سندوق/بانک پێویستە',
        saveSuccess: 'مەعاملەی کارمەند پاشەکەوت کرا',
        recent: 'مەعاملەکان',
        movements: 'مەعاملەکان',
        tabForm: 'کردار',
        openStatement: 'کەشفی حساب',
        accrueMonth: 'ئەم مانگە ماف',
        accrueSuccess: 'مافی مووچەی مانگانە دروست کرا',
        accrueNone: 'کارمەندێک بە مووچەی مانگانە نییە. مووچە لە کارت بنووسە.',
        accrueExists: 'مافی ئەم مانگە پێشتر تۆمار کراوە',
        accrueCleanedBeforeHire: 'پێش دەستبەکاربوون {n} مافی خۆکار سڕایەوە',
        accrueCleanedPastMonths: 'مانگەکانی پێشوو {n} مافی خۆکار سڕایەوە',
        accrueCleanedDuplicates: 'هەمان مانگ {n} مافی دووبارە سڕایەوە',
        movementsThisMonth: 'جوڵەی ئەم مانگە',
        movementsAll: 'هەموو جوڵەکان',
        movementsShowMonth: 'تەنها ئەم مانگە',
        movementsShowAll: 'هەموو مێژوو',
        movementsPriorBalance: 'مانگەکانی پێشوو باڵانس',
        voucherTitleSalary: 'پسوڵەی دانی مووچە',
        voucherTitleAdvance: 'پسوڵەی پێشەکی',
        voucherTitleReconcile: 'بەڵگەی پاکتاوکردنی پێشەکی',
        voucherTitleAccrual: 'پسوڵەی مافی مووچە',
      },
      statement: {
        title: 'کەشفی حسابی کارمەند',
        empty: 'لەم ماوەیەدا جووڵەی مووچە / پێشەکی نییە.',
        opening: 'کردنەوە',
        closing: 'باڵانسی ماوە',
        printVoucher: 'چاپکردنی پسوڵە',
        printError: 'چاپ نەکرا',
        loadError: 'کەشفی حساب بارنەبوو',
        printRowHint: 'بۆ ئەم ڕیزە پسوڵە نییە',
        showCancelled: 'پیشاندانی هەڵوەشێنراوەکان',
        hideCancelled: 'شاردنەوەی هەڵوەشێنراوەکان',
        showCancelledHint: 'لەخۆگرتنی ڕیزە هەڵوەشێنراوەکان (CANCELLED_*) لە کەشیفدا',
        cancelledBadge: 'هەڵوەشێنراو',
        excludeCompanyDebts: 'بەدەنی کۆمپانیا لابدە',
        excludeCompanyDebtsHint: 'دابەشکردنی قازانج و وەرگێڕانی سەرماوەی کۆمپانیا بشارەوە',
        excludeCompanyDebtsNoEffect: 'ئەم فلتەرە کاریگەری نییە لە کەشیفی کڕیار/دابینکەر',
        excludedBadge: 'لابرا',
        deleteRowTitle: 'جوڵە بسڕەوە',
        deleteRowHint: 'سڕینەوەی ئەم ڕیزە باڵانسی قاسە و هاوبەش دەگەڕێنێتەوە. دڵنیایت؟',
        deleteRowClickHint: 'بۆ سڕینەوە کلیک لە ڕیز یان ئایکۆنی سڕینەوە بکە',
        deleteRowOnlyUserAdded: 'تەنها دواتر زیادکراوی پارە هاتن/چوون دەسڕدرێتەوە؛ پشکی قازانجی ئۆتۆماتیکی نا',
        deleteRowSuccess: 'جوڵە سڕایەوە',
        deleteRowError: 'نەتوانرا جوڵە بسڕدرێتەوە',
      },
      distribution: {
        title: 'دابەشکردنی قازانج / زەرەر',
        subtitle: 'قازانج بەپێی ڕێژەی کارت بۆ حسابی هاوبەش بنووسە؛ پارە جیاواز دێت و دەچێت',
        openDistribution: 'دابەشکردن',
        baseType: 'بنەمای دابەشکردن',
        triggerType: 'شێوازی دەستپێکردن',
        manualAmount: 'بڕی دەستی',
        computedAmount: 'بڕی حیسابکراو',
        register: 'سندوق / بانک',
        chooseRegister: 'سندوق/بانک هەڵبژێرە',
        notes: 'تێبینی',
        registerRequired: 'سندوق/بانک پێویستە',
        accountOnlyHint: 'دابەشکردن سندوق ناگۆڕێت: بڕ بەپێی ڕێژە دەچێتە حسابی هاوبەش. بۆ هێنان یان کێشانی پارە، مەعاملەی پارەی هاوبەش بەکاربهێنە.',
        execute: 'جێبەجێکردنی دابەشکردن',
        executeSuccess: 'دابەشکردن جێبەجێکرا',
        previewTitle: 'پێشبینین',
        totalPct: 'کۆی ڕێژە',
        partner: 'هاوبەش',
        sharePct: 'ڕێژە %',
        amount: 'بڕ',
        total: 'کۆ',
        history: 'دابەشکردنە پێشووەکان',
        base: {
          netProfit: 'قازانجی خاوێن',
          netProfitDesc: 'فرۆشتنی کۆ − گەڕانەوە − خەرجی پەسەندکراو',
          cashNet: 'نەقدی خاوێن',
          cashNetDesc: 'پۆزیسیۆنی نەقدی کۆکراو',
          manual: 'بڕی دەستی',
          manualDesc: 'بەڕێوەبەر بڕەکە دەنووسێت',
        },
        trigger: {
          manual: 'دەستی',
          daily: 'ڕۆژانە (داخستنی سندوق)',
          period: 'کۆتایی ماوە',
        },
      },
      table: {
        code: 'کۆد',
        id: 'ناسنامە',
        idCopyHint: 'کۆپی ناسنامە',
        archived: 'ئەرشیف',
        archivedHint: 'ئەرشیفکراو (لەگەڵ هەژمارەیەکی تر تێکەڵکراوە)',
        name: 'ناو',
        type: 'جۆر',
        phone: 'تەلەفۆن',
        salary: 'مووچە',
      ...
      merge: {
        title: 'تێکەڵکردنی هەژمارەکان',
        subtitle: 'دوو کارتی هەژمارە لە یەک کارتی مەبەست تێکەڵ بکە. شوێنپێهەڵگرتن پارێزراوە.',
        openButton: 'تێکەڵکردن',
        source: 'سەرچاوە (ئەرشیف دەکرێت)',
        target: 'مەبەست (دەمێنێتەوە)',
        summary: 'ژمارەی ڕیزە کاریگەرەکان (هەموو خولەکان)',
        balanceAfter: 'باڵانسی مەبەست دوای تێکەڵکردن',
        balanceHint: 'جۆرەکانی کارتی جیاواز تێکەڵکراون — باڵانسەکان هێشتا کۆ دەکرێن. ئاڕاستەی نیشانە بەپێی جۆری کارت مامەڵەی لەگەڵ دەکرێت.',
        warnings: 'ئاگادارکردنەوەکان',
        notesLabel: 'تێبینی (بە هەڵبژاردن، بۆ پشکنین)',
        notesPlaceholder: 'بۆ نموونە: تۆماری دووبەر، ژمارەی تەلەفۆنی جیاواز',
        confirmText: 'تێدەگەم کە کارتی سەرچاوە ئەرشیف دەکرێت، هەموو مامەڵەکان دەگوازرێنەوە بۆ کارتی مەبەست، و باڵانسەکان کۆ دەکرێن. ئەمە بەرگێشە (هەڵوەشاندنەوەی تێکەڵکردن) — کارتی کۆنی ناچالاک دەمێنێتەوە بەڵام دراوەکانی پارێزراون.',
        preview: 'پێشبینین',
        execute: 'تێکەڵکردن پشتڕاست بکەرەوە',
        success: 'تێکەڵکردن تەواو. {{code}} ئەرشیفکرا.',
        doneTitle: 'تێکەڵکردن تەواو',
        doneText: '{{source}} → {{target}} تێکەڵکران.',
      },
      error: {
