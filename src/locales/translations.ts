  ...
  tr: {
    ...
    custColUniqueId: 'Benzersiz ID',
      ...
      distribution: {
        ...
        subtitle: 'Pay %\'lerine göre kâr veya zararı ortaklara bölüştür',
  ...
  en: {
    ...
    custColUniqueId: 'Unique ID',
      ...
      distribution: {
        ...
        subtitle: 'Distribute profit or loss to partners by share %',
  ...
  ar: {
    ...
    custColUniqueId: 'المعرف الفريد',
      ...
      distribution: {
        ...
        subtitle: 'توزيع الأرباح أو الخسائر على الشركاء حسب النسبة',
  ...
  ku: {
    ...
    custColUniqueId: 'ناسنامەی بێهاوتا',
      ...
      distribution: {
        ...
        subtitle: 'بەپێی ڕێژەی هاوبەشی، قازانج یان زەرەر بەسەر هاوبەشەکاندا دابەش بکە',
