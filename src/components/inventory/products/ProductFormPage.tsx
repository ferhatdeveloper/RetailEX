...
export const ProductFormPage = React.memo(({ productId, onClose, onSave }: ProductFormPageProps) => {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
      {/* Header */}
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between px-3 py-2 bg-white border-b border-gray-300">
        <div className="flex flex-wrap items-center gap-2 min-w-0">
          ...
          {formData.code && (
            <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded text-xs truncate max-w-full">
              {formData.code}
            </span>
          )}
        </div>
      ...
      <div className="bg-white border-b border-gray-300">
        <div className="flex overflow-x-auto touch-pan-x">
          {tabs.map((tab: any) => {
            const Icon = tab.icon;
            return (
              <button
                ...
                className={`flex shrink-0 items-center gap-1.5 px-3 py-2 text-xs border-r border-gray-300 transition-colors whitespace-nowrap ${activeTab === tab.id
        ...
        <div className="max-w-6xl mx-auto w-full min-w-0">
          ...
          {activeTab === 'genel' && (
            <div className="space-y-3">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-px bg-gray-300">
                  <div className="col-span-1 md:col-span-3 bg-gray-100 px-2 py-1.5">
                    <label className="text-xs text-gray-700">{tm('cardType')}</label>
                  </div>
                  <div className="col-span-1 md:col-span-3 bg-white px-2 py-1.5">
                    <select
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-px bg-gray-300">
                  ...
                  <div className="col-span-1 md:col-span-3 bg-white px-2 py-1.5 flex gap-1">
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-px bg-gray-300">
                  {[1, 2, 3, 4, 5, 6].map((num: number) => (
                    <div key={`special-code-${num}`} className="contents">
                      <div className="col-span-1 md:col-span-3 bg-gray-100 px-2 py-1.5 flex items-center">
                  ...
                  {productId && (
                    <div className="contents">
                      ...
                      <div className="col-span-1 md:col-span-9 bg-white px-2 py-1.5 flex items-center gap-1">
                        <input
                          type="text"
                          value={formData.id || ''}
                          readOnly
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-x-3 gap-y-2.5">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-px bg-gray-300">
                  ...
                  <div className="col-span-1 md:col-span-3 bg-white px-2 py-1.5 relative">
                    <input
                      type="number"
                      step="0.01"
                  ...
                  <div className="col-span-1 md:col-span-3 bg-green-50 px-2 py-1.5 relative">
                    <input
                      type="number"
                      step="0.01"
                  ...
                  <div className="col-span-1 md:col-span-3 bg-gray-50 px-2 py-1.5">
                    <input
                      type="text"
                      value={formData.purchasePrice > 0
                  ...
                  <div className="col-span-1 md:col-span-6 bg-gray-50 flex items-center px-4">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-px bg-gray-300">
                   <div className="col-span-1 md:col-span-3 bg-gray-100 px-2 py-1.5 flex items-center justify-between">
                  ...
                  <div className="col-span-1 md:col-span-6 bg-gray-50 px-2 py-1.5 flex items-center">
          ...
          {activeTab === 'birim-barkod' && (
            <div className="space-y-4">
              ...
              <div className="bg-white border border-gray-300">
                <div className="px-3 py-1.5 bg-gray-100 border-b border-gray-300 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <span className="text-[11px] text-gray-700 font-bold shrink-0">{tm('unitsAndBarcodeList')}</span>
          ...
          {activeTab === 'varyant' && (
            <div className="space-y-3">
              {/* Kaydet Uyarısı */}
              <div className="bg-amber-50 border border-amber-300 px-3 py-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  onClick={() => handleSave()}
                  className="flex items-center justify-center gap-1 px-4 py-1.5 bg-green-600 text-white rounded text-xs font-bold hover:bg-green-700 transition-colors shadow shrink-0 self-end sm:self-auto"
                >
                  <Save className="w-3.5 h-3.5" />
                  Kaydet (Varyantlarla)
                </button>
              ...
              {hasVariants && (
                <div>
                  <div className="bg-white border border-gray-300">
                    <div className="px-3 py-2 bg-gray-100 border-b border-gray-300 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <span className="text-xs text-gray-700 shrink-0">{tm('attributeDefinitions')}</span>
            ...
            <div className="space-y-4">
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 grid grid-cols-1 gap-2">
                  <div className="flex flex-col gap-1 md:grid md:grid-cols-12 md:items-center md:gap-0">
                    <div className="order-2 md:order-1 w-full md:col-span-9 bg-white px-2 py-1.5">
                      <input
                        type="text"
                    ...
                    <div className="order-1 md:order-2 w-full md:col-span-3 bg-gray-100 px-2 py-1.5 text-left md:text-right md:border-l md:border-white border-0">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <div className="flex flex-col gap-1 md:grid md:grid-cols-12 md:items-center mb-2">
                      <div className="order-2 md:order-1 w-full md:col-span-8">
                        <input
                          type="text"
                      ...
                      <div className="order-1 md:order-2 w-full md:col-span-4 text-left md:text-right pl-0 md:pl-2">
                        <label className="text-xs text-gray-700">{tm('warrantyType')}</label>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div className="flex flex-col gap-1 md:grid md:grid-cols-12 md:items-center">
                      <div className="order-2 md:order-1 w-full md:col-span-8">
                        <input
                          type="number"
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 space-y-2">
                  <div className="flex flex-col gap-1 md:grid md:grid-cols-12 md:gap-2">
                    <div className="order-2 md:order-1 w-full md:col-span-10">
                      <textarea
                    ...
                    <div className="order-1 md:order-2 w-full md:col-span-2 text-left md:text-right">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 space-y-2">
                  <div className="flex flex-col gap-1 md:grid md:grid-cols-12 md:gap-2 md:items-center">
                    <div className="order-2 md:order-1 w-full md:col-span-10">
                      <input
                        type="text"
