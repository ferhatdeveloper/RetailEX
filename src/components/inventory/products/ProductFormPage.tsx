...
export const ProductFormPage = React.memo(({ productId, onClose, onSave }: ProductFormPageProps) => {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 bg-white border-b border-gray-300 max-md:flex-col max-md:items-stretch max-md:gap-2">
        <div className="flex items-center gap-2 max-md:flex-wrap max-md:min-w-0">
          ...
          {formData.code && (
            <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded text-xs max-md:truncate max-md:max-w-full">
              {formData.code}
            </span>
          )}
        </div>
          ...
          {tabs.map((tab: any) => {
            ...
            return (
              <button
                ...
                className={`flex max-md:shrink-0 items-center gap-1.5 px-3 py-2 text-xs border-r border-gray-300 transition-colors whitespace-nowrap ${activeTab === tab.id
      ...
      {/* Content */}
      <div className="flex-1 overflow-auto p-3 max-md:p-2">
        <div className="max-w-6xl mx-auto max-md:w-full max-md:min-w-0">
          ...
          {activeTab === 'genel' && (
            <div className="space-y-3">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-12 gap-px bg-gray-300 max-md:grid-cols-1">
                  <div className="col-span-3 max-md:col-span-1 bg-gray-100 px-2 py-1.5">
                    <label className="text-xs text-gray-700">{tm('cardType')}</label>
                  </div>
                  <div className="col-span-3 max-md:col-span-1 bg-white px-2 py-1.5">
                    <select
                  ...
                  <div className="col-span-6 max-md:hidden" aria-hidden />
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-12 gap-px bg-gray-300 max-md:grid-cols-1">
                  ...
                  <div className="col-span-3 max-md:col-span-1 bg-white px-2 py-1.5 flex gap-1">
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-12 gap-px bg-gray-300 max-md:grid-cols-1">
                  {[1, 2, 3, 4, 5, 6].map((num: number) => (
                    <div key={`special-code-${num}`} className="contents">
                      <div className="col-span-3 max-md:col-span-1 bg-gray-100 px-2 py-1.5 flex items-center">
                  ...
                  {productId && (
                    <div className="contents">
                      ...
                      <div className="col-span-9 max-md:col-span-1 bg-white px-2 py-1.5 flex items-center gap-1">
                        <input
                          type="text"
                          value={formData.id || ''}
                          readOnly
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 grid grid-cols-5 gap-3 max-md:grid-cols-2 max-md:gap-y-2.5">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-12 gap-px bg-gray-300 max-md:grid-cols-1">
                  ...
                  <div className="col-span-3 max-md:col-span-1 bg-white px-2 py-1.5 relative">
                    <input
                      type="number"
                      step="0.01"
                  ...
                  <div className="col-span-3 max-md:col-span-1 bg-green-50 px-2 py-1.5 relative">
                    <input
                      type="number"
                      step="0.01"
                  ...
                  <div className="col-span-3 max-md:col-span-1 bg-gray-50 px-2 py-1.5">
                    <input
                      type="text"
                      value={formData.purchasePrice > 0
                  ...
                  <div className="col-span-6 max-md:col-span-1 bg-gray-50 flex items-center px-4">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="grid grid-cols-12 gap-px bg-gray-300 max-md:grid-cols-1">
                   <div className="col-span-3 max-md:col-span-1 bg-gray-100 px-2 py-1.5 flex items-center justify-between">
                  ...
                  <div className="col-span-6 max-md:col-span-1 bg-gray-50 px-2 py-1.5 flex items-center">
          ...
          {activeTab === 'stok' && (
            <div className="space-y-3">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 grid grid-cols-3 gap-3 max-md:grid-cols-1">
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
          ...
          {activeTab === 'birim-barkod' && (
            <div className="space-y-4">
              ...
              <div className="bg-white border border-gray-300">
                <div className="px-3 py-1 bg-gray-100 border-b border-gray-300 flex items-center justify-between max-md:flex-col max-md:items-stretch max-md:gap-2 max-md:py-1.5">
          ...
          {activeTab === 'varyant' && (
            <div className="space-y-3">
              {/* Kaydet Uyarısı */}
              <div className="bg-amber-50 border border-amber-300 px-3 py-2 flex items-center justify-between max-md:flex-col max-md:items-stretch max-md:gap-2">
                ...
                <button
                  onClick={() => handleSave()}
                  className="flex items-center gap-1 px-4 py-1.5 bg-green-600 text-white rounded text-xs font-bold hover:bg-green-700 transition-colors shadow max-md:self-end"
                >
                  <Save className="w-3.5 h-3.5" />
                  Kaydet (Varyantlarla)
                </button>
              ...
              {hasVariants && (
                <div>
                  <div className="bg-white border border-gray-300">
                    <div className="px-3 py-2 bg-gray-100 border-b border-gray-300 flex items-center justify-between max-md:flex-col max-md:items-stretch max-md:gap-2">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 grid grid-cols-1 gap-2">
                  <div className="grid grid-cols-12 items-center max-md:grid-cols-1">
                    <div className="col-span-9 bg-white px-2 py-1.5 max-md:col-span-1 max-md:order-2">
                      <input
                        type="text"
                    ...
                    <div className="col-span-3 bg-gray-100 px-2 py-1.5 text-right border-l border-white max-md:col-span-1 max-md:order-1 max-md:text-left max-md:border-l-0">
          ...
          {activeTab === 'ek-bilgi' && (
            <div className="space-y-4">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 grid grid-cols-2 gap-4 max-md:grid-cols-1">
                  <div>
                    <div className="grid grid-cols-12 items-center mb-2 max-md:grid-cols-1">
                      <div className="col-span-8 max-md:col-span-1 max-md:order-2">
                        <input
                          type="text"
                      ...
                      <div className="col-span-4 text-right pl-2 max-md:col-span-1 max-md:order-1 max-md:text-left max-md:pl-0">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 space-y-2">
                  <div className="grid grid-cols-12 gap-2 max-md:grid-cols-1">
                    <div className="col-span-10 max-md:col-span-1 max-md:order-2">
                      <textarea
                    ...
                    <div className="col-span-2 text-right max-md:col-span-1 max-md:order-1 max-md:text-left">
              ...
              <div className="bg-white border border-gray-300">
                ...
                <div className="p-3 space-y-2">
                  <div className="grid grid-cols-12 gap-2 items-center max-md:grid-cols-1">
                    <div className="col-span-10 max-md:col-span-1 max-md:order-2">
                      <input
                        type="text"
