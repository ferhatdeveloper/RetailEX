...
export function InvoiceCariSelectModal({
  ...
  return (
    ...
    >
      <div className={`p-3 border-b flex items-center justify-between shrink-0 bg-gradient-to-r ${headerGradient} ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
        ...
        {onCreate && (
          <div className={`px-4 pb-3 border-t pt-3 shrink-0 ${darkMode ? 'border-gray-700 bg-gray-900/80' : 'border-gray-100 bg-gray-50/80'}`}>
            {showQuickAdd ? (
              <div className="space-y-2">
                <input
                  type="text"
