    ...
    <PercentBodyModal onClose={onClose} size="form" ariaLabel={modalTitle}>
      ...
      >
        ...
        <PercentBodyModalScrollBody className="p-8">
          ...
          {isCustomer && (
            <div className="mt-4 w-full border border-slate-200 bg-slate-50/80 p-4">
                ...
                {getLocalizedWeekdayLabels(dateLocale).map((day) => {
                  ...
                  return (
                    <button
                      ...
                      className={`min-h-[48px] min-w-0 flex-1 border px-1 py-2 text-xs font-bold uppercase tracking-wide transition-colors sm:text-sm ${
                        selected
              ...
              <label className="mb-1 mt-3 block text-[11px] font-bold uppercase tracking-wider text-slate-500">
                {tm('callPlanNote')}
              </label>
              <textarea
