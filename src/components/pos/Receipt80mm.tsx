...
import { beautyReceiptStaffNames, isBeautyReceiptSale } from '../../utils/beautyReceiptLayout';
...
export function Receipt80mm({
  ...
  const isBeautyReceipt = useMemo(() => isBeautyReceiptSale(sale), [sale]);
  const beautyStaffList = useMemo(() => beautyReceiptStaffNames(sale), [sale]);
          ...
          >
            ...
            <div data-section="header" className="text-center border-b-[3px] border-dashed border-gray-900 pb-2 mb-2 receipt-print-dark">
              ...
              {receiptSettings?.companyPhone && (
                <div className="text-[12px] font-bold text-gray-900 mt-0.5 print:text-[10px] print:font-bold">
                  {receiptSettings.companyPhone}
                </div>
              )}
            </div>
