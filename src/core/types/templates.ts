...
export const DEFAULT_TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    name: 'Hasta Dosya Tasarımı',
    description:
      'Klinik / güzellik müşteri kartı — dosya no, iletişim ve not alanları; Müşteri Yönetimi\'nden yazdırılır',
    type: 'invoice',
    format: 'A4',
    width: 210,
    height: 297,
    ...
    elements: [
      ...
      },
      {
        ...
        width: 170,
        height: 14,
        content: 'Dosya No: {{customerFileNo}}\nCari Kod: {{customerCode}}',
        fontSize: 13,
        fontWeight: 'bold',
        textAlign: 'left',
      },
      ...
      },
      {
        ...
        height: 68,
        content:
          'Ad Soyad: {{customerName}}\nTelefon: {{customerPhone}}    Tel 2: {{customerPhone2}}\nE-posta: {{customerEmail}}\nAdres: {{customerAddress}}\nŞehir: {{customerCity}}\nDoğum: {{customerBirthDate}}    Yaş: {{customerAge}}    Cinsiyet: {{customerGender}}\nMeslek: {{customerOccupation}}    Tip: {{customerTier}}',
        fontSize: 10,
        textAlign: 'left',
      },
      {
        ...
        width: 180,
        height: 10,
        content: 'Bakiye: {{customerBalance}}    Puan: {{customerPoints}}    Kaynak: {{heardFrom}}',
        fontSize: 10,
        textAlign: 'left',
      },
      {
