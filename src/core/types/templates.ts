...
export const INVOICE_FIELDS = {
  ...
  '{{customerPhone2}}': 'Müşteri Telefon 2',
  ...
  '{{customerFileNo}}': 'Dosya No',
  '{{fileId}}': 'Dosya No (file_id)',
  '{{customerAge}}': 'Yaş',
  '{{customerBirthDate}}': 'Doğum Tarihi',
  '{{customerBirthDay}}': 'Doğum Günü (gg)',
  '{{customerBirthMonth}}': 'Doğum Ayı (aa)',
  '{{customerBirthYear}}': 'Doğum Yılı (yyyy)',
  '{{customerBirthYear2}}': 'Doğum Yılı (son 2 hane)',
  '{{customerOccupation}}': 'Meslek',
  '{{customerGender}}': 'Cinsiyet',
  '{{customerTier}}': 'Müşteri Tipi',
  '{{customerNotes}}': 'Müşteri Notları',
  '{{customerBalance}}': 'Cari Bakiye',
  '{{customerPoints}}': 'Puan',
...
export const DEFAULT_TEMPLATES: Template[] = [
  ...
  {
    id: 'default-a4-patient-file',
    name: 'Hasta Dosya Tasarımı (Antetli)',
    description:
      'Antetli kağıt için — üst ~45 mm boş (basılı antet); dosya no, ad, telefon ve diğer müşteri alanları form satırlarına yazılır',
    type: 'invoice',
    format: 'A4',
    width: 210,
    height: 297,
    orientation: 'portrait',
    engine: 'fastreport-like',
    usageScopes: ['patient_file', 'global'],
    defaultScopes: ['patient_file'],
    margin: { top: 8, right: 15, bottom: 15, left: 15 },
    isDefault: false,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    elements: [
      // Üst 0–45 mm: antetli kağıt logosu / klinik başlığı için boş bırakılır
      {
        id: 'pf-file-no',
        type: 'text',
        x: 130,
