...
- **Build Optimization**: Optimize binaries for Windows, Linux, and Mobile.
- **Cross-Platform Compatibility**: Ensure the desktop app works flawlessly across OS environments.

## Guidelines
1. Master the Tauri `invoke` patterns and Rust-side performance.
2. Debug native driver or hardware integration issues.
3. Manage the compilation and packaging of high-performance desktop apps.
