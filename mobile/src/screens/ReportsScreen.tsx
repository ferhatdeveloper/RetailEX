...
const LIVE_REPORTS: ReportEntry[] = [
  ...
  },
  {
    ...
    desc: 'Satış özeti üzerinden finans görünümü',
    kind: 'stack',
    route: 'ReportSales',
    Icon: Users,
  },
...
const MENU_REPORTS: ReportEntry[] = [
  ...
  },
  {
    id: 'extract',
    title: 'Cari Ekstre',
    desc: 'Cari detay + son faturalar',
    kind: 'module',
    screen: 'customer-extract',
    Icon: Users,
  },
  {
    id: 'mizan',
    title: 'Mizan Raporu',
    desc: 'İskelet host — Faz 4 SQL',
    kind: 'module',
    screen: 'mizan',
    Icon: BarChart3,
  },
